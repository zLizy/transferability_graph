...
def get_dataset_features(unique_dataset_id,df,reference_model='resnet50',approach='domain_similarity'):
    ...
    for i, row in unique_dataset_id.iterrows():
        ...
        if approach == 'domain_similarity':
            ...
            # path = os.path.join(f'../dataset_embed/{approach}/feature','Ahmed9275_Vit-Cifar100',f'{ds_name}_feature.npy')
            # path = os.path.join(f'../dataset_embed/{approach}/feature','johnnydevriese_vit_beans',f'{ds_name}_feature.npy')
            # path = os.path.join(f'../dataset_embed/{approach}/feature','aricibo_swin-tiny-patch4-window7-224-finetuned-eurosat',f'{ds_name}_feature.npy')
            path = os.path.join(f'../dataset_embed/{approach}/feature',reference_model,f'{ds_name}_feature.npy')
