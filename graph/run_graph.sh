...
do
    ...
    do
        ...
        for dataset in oxford_iiit_pet oxford_flowers102
        do
            #  smallnorb_label_azimuth eurosat diabetic_retinopathy_detection 
            #   kitti   cifar100 svhn stanfordcars dtd caltech101 smallnorb_label_elevation
                                ...
                                do
                                    ...
                                    do 
                                        ...
                                        do
                                            ...
                                            for GNN_METHOD in lr_homo_SAGEConv lr_homoGATConv lr_homoGCNConv lr_homo_SAGEConv_without_accuracy lr_homoGATConv_without_accuracy
