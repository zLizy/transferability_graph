...
dataset2label = {'chest-xray-pneumonia': "['NORMAL', 'PNEUMONIA']",
                 'Matthijs/snacks': 
                 ...
                 'FastJobs/Visual_Emotional_Analysis':"['anger', 'contempt', 'disgust', 'fear', 'happy', 'neutral', 'sadness', 'surprise']",
                 'eurosat':
